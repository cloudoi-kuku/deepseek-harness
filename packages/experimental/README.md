...
| [`hosted-generate`](hosted-generate/README.md) | Loopback generate API: disposable workspace, UTF-8 file-map artifact, no deploy | `ctx.hostedGenerate` |
