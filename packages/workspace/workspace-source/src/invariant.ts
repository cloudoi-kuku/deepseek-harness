...
/**
 * No runtime invariant: provider maps are private and kind dispatch is
 * enforced on each call; the seam publishes no independent registry or
 * checkout observation stream.
 */
