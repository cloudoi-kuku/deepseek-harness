...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  WorkspaceSpec: 'workspace.md',
  GitWorkspaceSourceProvider: 'workspace.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  GenerateArtifact: 'hosted generate artifact payload is owned by packages/experimental/hosted-generate/README.md',
  GenerateSessionId: 'hosted generate session identity is owned by packages/experimental/hosted-generate/README.md',
  GenerateStartRequest: 'hosted generate request payload is owned by packages/experimental/hosted-generate/README.md',
  GenerateStatus: 'hosted generate status payload is owned by packages/experimental/hosted-generate/README.md',
